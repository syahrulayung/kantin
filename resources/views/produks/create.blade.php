@extends('layouts.app', ['title' => __('Insert')])

@section('content')
    @include('produks.partials.header', ['title' => __('Add')])   
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="/produks" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="/storre" autocomplete="off">
                            @CSRF
                            
                            <h6 class="heading-small text-muted mb-4">{{ __('Produk information') }}</h6>
                            <div class="pl-lg-4">
